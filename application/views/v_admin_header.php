      ...
      <ul class="sidebar-menu">
        <li class="<?php echo $menu_admin;?>">
          <a href="<?php echo base_url(); ?>admin">
            <i class="fa fa-users"></i> <span>Halaman Konfirmasi</span>
          </a>
        </li>
		<li class="<?php echo $menu_matakuliah;?>">
          <a href="<?php echo base_url(); ?>admin/matakuliah">
            <i class="fa fa-pencil-square"></i> <span>Input Matakuliah</span>
          </a>
        </li>
		...
		<li class="<?php echo $menu_laporan;?>">
          <a href="<?php echo base_url(); ?>admin/laporan/0/0">
            <i class="fa fa-file-text"></i> <span>Laporan</span>
          </a>
        </li>
		<li class="<?php echo $menu_grafik;?>">
          <a href="<?php echo base_url(); ?>admin/grafik/0/0/0">
