				...
				<div class="box-header">
						<table width="100%">
							...
							<div class="form-group">
								<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>admin/laporan/'+this.value+'/0'">
									<?php
									$geturlmatakuliah = $this->uri->segment(3);
							...
							<td width="20%">
							<div class="form-group">
								<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>admin/laporan/<?php echo $geturlmatakuliah;?>/'+this.value">
									<?php
							...
							<td width="20%">
							<div class="form-group">
								<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>admin/laporan/<?php echo $geturlmatakuliah;?>/<?php echo $geturlpertemuan;?>/'+this.value">
									<?php
									...
									for($group = 1; $group <=$jumlah_mahasiswa_matakuliah; $group++){
		...
		<div class="col-xs-12">
				<div class="box">
					...
					<table class="table table-bordered table-striped" border="1">
						<tr>
							<td>Mata Kuliah </td><td>: </td><td><?php echo $tbl_admin_matakuliah_2->matakuliah_nama;?></td>
						</tr>
						<tr>
					...
					<h5 class="box-title">
						<center><label>Hasil Pengelompokan Berdasarkan Nama</label></center>
					</h5>
						...
						for($transformer=0; $transformer<$tampil_baris; $transformer++){
							echo "<tr>";
								for($urutan = $jumlah_kelompok*$transformer+1; $urutan <= $jumlah_kelompok*($transformer+1) ; $urutan++){
									echo "<td>"; echo $data_sorting_user_fullname[$urutan]; echo "</td>";
								}
							echo "</tr>";
						}
}							
?>
		...
		<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
					<h5 class="box-title">
						<center><label>Hasil Pengelompokan Berdasarkan NIM</label></center>
					</h5>
					  <table id="example8" class="table table-bordered table-striped" border="1" width="100%">
						<thead>
						<tr>
