					...
					<div class="col-md-6">
					  <div class="form-group">
						...
						<select type="text" class="form-control select2" name="matakuliah_id">
							<option value="<?php echo set_value('matakuliah_id', $tbl_admin_materi->matakuliah_id); ?>"><?php echo set_value('matakuliah_nama', $tbl_admin_materi->matakuliah_nama); ?></option>
							<?php
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" name="materi_pertemuan" value="<?php echo set_value('materi_pertemuan', $tbl_admin_materi->materi_pertemuan); ?>">
					  </div>
					  <div class="form-group">
