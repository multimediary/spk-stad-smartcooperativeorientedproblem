		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-body">
					...
					<?php
					$no = 1;
					foreach($tbl_mahasiswa_tugas as $data){
						  echo "<tr>
						  <td>".$no."</td>
						  <td>".$data->matakuliah_nama."</td>
						  <td>
						   <a class='btn-sm btn-warning' href='".base_url("mahasiswa/tugas/".$data->matakuliah_id)."'><i class='fa fa-eye'></i> Lihat Tugas</a>
						  </td>
						  </tr>";
						  $no++;
					}
						...
						<div class="box-body no-padding">
							<table class="table table-bordered table-striped table-condensed">
								...
								<tr>
									...
									<td width="5%" style="text-align:center;"> : </td>
									<td>
										<select type="text" class="form-control select2" onchange="if (this.value) window.location='<?php echo base_url();?>mahasiswa/tugas/<?php echo $getmatakuliah;?>/'+this.value">
											<option><?php 
