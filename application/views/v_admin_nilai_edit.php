				  ...
				  <?php echo form_open("admin/nilai_aksi_ubah/".$tbl_admin_nilai->nilai_id); ?>
					<div class="col-md-6">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" value="<?php echo set_value('matakuliah_nama', $tbl_admin_nilai->matakuliah_nama); ?>" readonly>
					  </div>
					  <div class="form-group">
						<label>Pertemuan</label>
						<input type="text" class="form-control" name="nilai_pertemuan" value="<?php echo set_value('nilai_pertemuan', $tbl_admin_nilai->nilai_pertemuan); ?>">
					  </div>
					  <div class="form-group">
						<label>Nilai</label>
